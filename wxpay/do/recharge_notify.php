...
*/
	...
	$db->query("update `twotree_recharge` set pay_status=1,pay_time=$timestamp where out_trade_no='$out_trade_no'");
	/*if($result_code=='SUCCESS'&&$return_code=='SUCCESS'){
		file_put_contents('pay.txt',"update ty_wx_order set is_pay=1,pay_time=$timestamp where code=$out_trade_no");
		$db=new Connection();               //创建数据库链接
