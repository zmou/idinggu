    ...
    */
    public function edit()
    {
        ...
        if ($arr = $this->_post()) {
            ...
            $this->success('保存成功', U('edit', array(
                'id' => $id
            )));
        } else {
            $this->display();
    ...
    */
    ...
    public function get_shop_data()
    {
        ...
        foreach ($shop_list as $shops) {
            $shop_user = M('order_info')->where(array(
                'user_id' => $shops['uid'],
                'role_id' => 2,
                'build_id' => array(
                    'neq',
        ...
        $user_list = M('wechat_user')->where(array(
            'id' => array(
                'IN',
                $user_ids
            )
        ...
        foreach ($user_list as $k => $user) {
            $user_order = M('order_info')->where(array(
                'role_id' => 2,
                'user_id' => $user['id']
            ))->find();
