...
<div class="tab-content default-tab" id="tab1">
    <form method="post" action="<?php echo U('Admin/RBAC/addNodeHandle');?>">
      <fieldset>
        <p>
            <?php echo ($type); ?>名称：<input type="text" name="name"  class="text-input small-input" placeholder="节点名称"/> 
        </p>
        <p>
            <?php echo ($type); ?>描述：<input type="text" name="title"  class="text-input small-input" placeholder="节点描述"/> 
        </p>
        <p>
        ...
        <p>
            <?php echo ($type); ?>排序：<input type="text" name="sort"  class="text-input small-input" value="1" placeholder="节点排序"> 
        </p>                
        <p>
