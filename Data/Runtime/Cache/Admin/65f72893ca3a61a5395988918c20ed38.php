...
<div class="tab-content default-tab" id="tab1">
    <form id="form" method="post" action="<?php echo U('edit',array('id'=>$data['id']));?>">
        ...
        <p>
            ...
            <b><?php echo (order_status($data["order_status"])); ?></b>
        ...
        <p>
            支付状态：【
            <?php switch($data["pay_status"]): case "0": ?><font style="color:red">未支付</font><?php break;?>
        ...
        <?php if(($data["remark1"]) != ""): ?><p>
                发货备注：【<?php echo ($data["remark1"]); ?>】
            </p><?php endif; ?>
        
        <?php if(($data["remark2"]) != ""): ?><p>
                签收备注：【<?php echo ($data["remark2"]); ?>】
            </p><?php endif; ?>
        ...
        <?php if($data['shop_id'] > 0): ?><p><a class="button">分佣信息</a></p>  
        <div class="block">    
       	<p>
            分佣状态：<?php if(($data["fenyong_status"]) == "1"): ?><font color='green'>已分佣</font>
            <?php else: ?>
            <font color="red">未分佣</font><?php endif; ?>
        </p>
        <table>
        <thead><tr><td>账户信息</td><td>分销等级</td><td>佣金比例</td><td>佣金</td></tr></thead>
        <?php if(!empty($resaler1)): ?><tr>
            <td><?php echo ($resaler1["username"]); ?></td>
            <td>一级分销</td>
            <td><?php echo ($resaler1["percent"]); ?> %</td>
            <td>&yen;<?php echo ($resaler1["yongjin"]); ?></td>
            </td>
        </tr><?php endif; ?>
        <?php if(!empty($resaler2)): ?><tr>
            <td><?php echo ($resaler2["username"]); ?></td>
            <td>二级分销</td>
            <td><?php echo ($resaler2["percent"]); ?>%</td>
            <td>&yen;<?php echo ($resaler2["yongjin"]); ?></td>
            </td>
        </tr><?php endif; ?>
        </table>
        </div><?php endif; ?>
...
<!--
        ...
        <p>
            配送方式：【
            <?php if(($data["express_name"]) == ""): ?>不限
            <?php else: ?>
            <?php echo ($data["express_name"]); endif; ?>
            】
        </p> 
         <p>
             快递费用：【&yen; <?php echo ($data["express_fee"]); ?>】
        </p>    
       </div>
       -->
       ...
       <p><a class="button">下单人信息</a></p>    
        <div class="block">    
        <p>
            账户名：【<?php echo ($user["username"]); ?>】
        </p>
        <p>
            昵称：【<?php echo ($user["nickname"]); ?>】
        </p>
        <p>
            角色：【
        ...
        <?php if(($data["shop_id"]) != "0"): ?><p><a class="button">店铺信息</a></p>
        <div class="block">
        <p>
            店铺名称：【<?php echo ($shop["shop_name"]); ?>】
        </p>
        </div><?php endif; ?>
