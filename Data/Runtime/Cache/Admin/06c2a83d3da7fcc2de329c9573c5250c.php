...
<div class="tab-content default-tab" id="tab1">
            <form method="post" action="<?php echo U('jifen');?>">
            	<!--<p>
                   注　　册：<input type="text" name="reg"  class="text-input small-input num" value="<?php echo ($info["reg"]); ?>" placeholder="注册" required>咕币
                </p>
                <p>
                    每日登录：<input type="text" name="login"  class="text-input small-input num" value="<?php echo ($info["login"]); ?>" placeholder="登录" required>咕币
                </p>
                <p>
                   分　　享：<input type="text" name="share"  class="text-input small-input num" value="<?php echo ($info["share"]); ?>" placeholder="分享" required>咕币
                </p>-->
                <p>
                   每日签到：<input type="text" name="sign"  class="text-input small-input num" value="<?php echo ($info["sign"]); ?>" placeholder="签到" required> 咕币
                </p>
                <p>
                   朋友请　：<input type="text" name="friend"  class="text-input small-input num" value="<?php echo ($info["friend"]); ?>" placeholder="朋友请" required> 咕币
                </p>
             	<p>
                   邀请好友：<input type="text" name="reg_tui"  class="text-input small-input num" value="<?php echo ($info["reg_tui"]); ?>" placeholder="邀请好友" required>咕币
                </p>              
               <p>
