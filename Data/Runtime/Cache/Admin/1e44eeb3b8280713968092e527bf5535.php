...
<h4>角色列表</h4>  
<a class="btn align-right" style="margin:5px 10px;" href="<?php echo U('addRole');?>">新增</a> 
            ...
            <table>
              ...
              <tbody>
                <?php if(is_array($role)): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td>
                      	<a href="<?php echo U('editRole',array('id'=>$v['id']));?>" class="btn btn-success">编辑</a>
                        <a href="<?php echo U('access',array('rid'=>$v['id']));?>" class="btn btn-success">配置权限</a>
                        <a href="<?php echo U('delRole',array('id'=>$v['id']));?>" class="confirm btn btn-danger">删除</a>
                      </td>
