...
<div class="tab-content default-tab" id="tab1">
    <div class="notification success png_bg" id="dmsg">
        ...
        <div>
            ...
            <form method="post" action="<?php echo U('confHandle');?>">
              <fieldset>
                <p>
                    公众号名称　：<input required="" type="text" name="pubchatname" id="small-input" class="text-input small-input" value="<?php echo ($conf["pubchatname"]); ?>"> 
                </p>

                <p>
                    公众号ID　　：<input required="" type="text" name="pubchatid" id="small-input" class="text-input small-input" value="<?php echo ($conf["pubchatid"]); ?>"> 
                </p>
                <p>
                    TOKEN&nbsp;&nbsp;　　：<input required="" type="text" name="token" id="small-input" class="text-input small-input" value="<?php echo ($conf["token"]); ?>"> 
                </p>                
                <p>
                   APPID　　　：<input type="text" name="appid" id="small-input" class="text-input small-input" value="<?php echo ($conf["appid"]); ?>"> 
                </p>                
                <p>
                   APPSECRET：<input type="text" name="appsecret" id="small-input" class="text-input small-input" value="<?php echo ($conf["appsecret"]); ?>"> 
                </p> 
                <p>
                   商户号　　　：<input type="text" name="mchid" id="small-input" class="text-input small-input" value="<?php echo ($conf["mchid"]); ?>"> 
                </p>
                <p>
                   支付秘钥　　：<input type="text" name="partnerkey" id="small-input" class="text-input small-input" value="<?php echo ($conf["partnerkey"]); ?>"> 
                </p>               
               <!-- <p>
                ...
                <p>
                  接口地址　　：<a target='_blank' href="/?g=Wx&token=<?php echo ($conf["token"]); ?>">http://<?php echo I('server.HTTP_HOST');?>/?g=Wx&token=<?php echo ($conf["token"]); ?></a>
