...
<form method="post" action="<?php echo U('edit',array('id'=>I('get.id')));?>" enctype="multipart/form-data">
    <fieldset>
        <input type="hidden" name="linkid" value="<?php echo ($info["linkid"]); ?>"> 
    <p>
        链接标题：
        	<input type="text" name="linkname"  class="text-input small-input" value="<?php echo ($info["linkname"]); ?>"> 
    </p>
    <p>
        链接地址：
                <input type="text" name="linkurl"  class="text-input small-input" value="<?php echo ($info["linkurl"]); ?>" placeholder='链接地址格式http://www.baidu.com'>
    </p>
    <p>
        链接排序：
                <input type="text" name="linklist"  class="text-input small-input" value="<?php echo ($info["linklist"]); ?>" placeholder='顺序排列'>
    </p>
    <p>
        是否显示：
        	<select name="linktype">
                    <option value="1" <?php if($linkdata["linktype"] == 1): ?>selected<?php endif; ?>>显示</option>
                    <option value="0" <?php if($linkdata["linktype"] == 0): ?>selected<?php endif; ?>>隐藏</option>
                </select>
    </p>
    <p>
        链接logo：
         <input readonly name="linklogo" type="text" id="url1" value="<?php echo ($nrs["spic"]); ?>" class="text-input small-input"/> 
