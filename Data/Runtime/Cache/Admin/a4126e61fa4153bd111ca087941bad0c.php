...
<a href="<?php echo U('add');?>" style="float: right;font-weight: 700;margin:5px 10px;" class="btn">新增</a>
        ...
        <div class="content-box-content">
          ...
          <div class="tab-content default-tab" id="tab1">
		    ...
		    <fieldset>			  
    <p>
	<form action="<?php echo U('index');?>" type="get">
     关键字：<input id="keyword" name="keyword" placeholder="请输入学校名称" class="text-input small-input" value="<?php echo I('get.keyword');?>"/>
	 <input type="hidden" name="g" value="Admin">
	 <input type="hidden" name="m" value="School">
	 <input type="hidden" name="a" value="index">
     <input type="submit" class="button btn-so" value="搜索">
 </form>
    </p>
</fieldset>
            <table>
              ...
              <tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td><?php echo ($v["prov"]); ?>-<?php echo ($v["city"]); ?>-<?php echo ($v["county"]); ?></td>
                      <td>
                      	<a class="btn btn-success" href="<?php echo U('Building/index',array('sch_id'=>$v['id']));?>" >宿舍楼</a>
                      
                        <a class="btn btn-success" href="<?php echo U('edit',array('id'=>$v['id']));?>" >修改</a>                  	
                        <a class="btn btn-danger" href="<?php echo U('del',array('id'=>$v['id']));?>" onClick="return confirm('确定要删除?')" >删除</a> 
                      </td>
