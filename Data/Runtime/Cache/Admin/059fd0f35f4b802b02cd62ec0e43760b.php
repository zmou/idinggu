...
<h4>商品分类</h4>  
<a style="margin:6px 10px;float:right" class="btn" href="<?php echo U('add');?>">添加分类</a> 
            ...
            <table>
              ...
              <tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                      <td>【<?php echo ($v["id"]); ?>】</td>
                      <td><?php if(($v["pre"]) != ""): ?>|<?php echo ($v["pre"]); endif; echo ($v["name"]); ?></td>
                      <td> 
                      <?php if(($v["spic"]) != ""): $picurl=base64_encode($v['spic']); ?>
                          <a rel="modal" title="查看原图" href="<?php echo U('Index/show_img',array('picurl'=>$picurl));?>" target="_blank">
                          <img src="<?php echo ($v["spic"]); ?>" class='thumb'></a><?php endif; ?></td>
                      <!--<td>商品</td>-->
                      <td><a href="#" class="btn"><?php if(($v["is_show"]) == "1"): ?>显示<?php else: ?>隐藏<?php endif; ?></a></td>
                      <td><a class='btn'><?php echo ($v["list"]); ?></a></td>
                      <td>
                      	<!-- <a class="btn btn-success" href="<?php echo U('Goods/index',array('cid'=>$v['id']));?>" title="查看该分类下的商品">查看商品</a>-->
