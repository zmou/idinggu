            ...
            <table>
              ...
              <tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td>【<?php echo ($v["city"]); ?>】-【<?php echo ($v["county"]); ?>】-【<?php echo ($v["school"]); ?>】-【<?php echo ($v["build"]); ?>】</td>
                      <td><a class="btn"><font color="red">等待审核</font></a></td>
                      <td><?php echo (date('Y-m-d H:i:s',$v["posttime"])); ?></td>
                      <td>
                        <a class="btn btn-success" href="<?php echo U('set_account',array('id'=>$v['uid']));?>">开通</a>
						<a class="btn btn-danger" onclick="return confirm('确定删除？')" href="<?php echo U('del',array('id'=>$v['uid']));?>" id="<?php echo ($v["id"]); ?>"> 删除</a>
                      </td>
