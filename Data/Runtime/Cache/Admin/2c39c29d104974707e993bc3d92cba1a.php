        ...
        <div class="content-box-content">
          ...
          <div class="tab-content default-tab" id="tab1">
            <table width='100%'>
              ...
              <tbody>
                <?php if(is_array($feedback)): $i = 0; $__LIST__ = $feedback;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                      <td>【<?php echo ($v["uid"]); ?>】</td>	
					  
					  <td>
	                      <?php if(($v["type"]) == "1"): ?>功能意见<?php endif; ?>
	                      <?php if(($v["type"]) == "2"): ?>页面意见<?php endif; ?>
	                      <?php if(($v["type"]) == "3"): ?>操作意见<?php endif; ?>
	                      <?php if(($v["type"]) == "4"): ?>其他<?php endif; ?>
                      </td>	
					  <td>
						  <?php echo ($v["content"]); ?>
					  </td>
