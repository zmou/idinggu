            ...
            <form method="post" action="<?php echo U('sortaddhandle',array('id'=>I('get.id')));?>" enctype="multipart/form-data">
              <fieldset>
               ...
               <!-- <p>
                ...
                <p>
                    外链地址：<input type="text" name="url" id="small-input" class="text-input small-input" value="<?php echo ($nrs["url"]); ?>"> 
                </p>
              <!--   
                <p>
			    ...
			    <p>
			    	文章内容：<textarea id="myEditor" name="descrip" style="height:300px;"><?php echo (stripslashes(htmlspecialchars_decode($nrs["descrip"]))); ?></textarea>
			    </p>                 
