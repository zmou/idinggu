...
<div class="tab-content default-tab" id="tab1">
    <form method="post" action="<?php echo U('add');?>">
      <fieldset>
        <p>
            品牌名称：<input  required type="text" name="name" class="text-input small-input"> 
        </p>
         <p>
            所属分类：
            ...
            <?php if(is_array($categorys)): $i = 0; $__LIST__ = $categorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><input name='cid[]' type='checkbox' value="<?php echo ($val["id"]); ?>"><?php echo ($val["name"]); ?>&nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?>
        </p>
        <p>
        分类logo：
        ...
        <p>
            显示排序：<input value="99" type="text" name="list" class="text-input small-input"> 
        </p>
        <p>
