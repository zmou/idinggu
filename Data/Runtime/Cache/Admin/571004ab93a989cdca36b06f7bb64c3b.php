...
<div class="tab-content default-tab" id="tab1">
    <form method="post" action="<?php echo U('edit',array('id'=>I('get.id')));?>">
      <fieldset>
        <p>
            分类名称：<input value="<?php echo ($info["name"]); ?>" required type="text" name="name"  class="text-input small-input"> 
        </p>
         <p>
            上级分类：
            		<select name='fup'>
                    	<option value='0'>-顶级分类-</option>
                    	<?php if(is_array($catelist)): $i = 0; $__LIST__ = $catelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option value="<?php echo ($item['id']); ?>" <?php if(($info["fup"]) == $item['id']): ?>selected<?php endif; ?> ><?php echo ($item['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select> 
        </p>
        <p>
        分类logo：
        ...
        <p>
            首页显示：
            		<select name='is_show'>
                    <option value='1' <?php if(($info["is_show"]) == "1"): ?>selected<?php endif; ?> >显示</option>
                    <option value='2' <?php if(($info["is_show"]) == "2"): ?>selected<?php endif; ?> >隐藏</option>
                    </select>
        </p>
        <p>
            显示排序：<input value="<?php echo ($info["list"]); ?>" required type="text" name="list"  class="text-input small-input"> 
        </p>
        <p>
