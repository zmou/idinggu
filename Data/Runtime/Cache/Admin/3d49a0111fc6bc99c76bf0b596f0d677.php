            ...
            <table>
              ...
              <tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td>
                      【<?php echo ($v["shop"]["prov"]); ?>
                     -<?php echo ($v["shop"]["city"]); ?>
                     -<?php echo ($v["shop"]["town"]); ?>
                     -<?php echo ($v["shop"]["school"]); ?>-<?php echo ($v["shop"]["build"]); ?>】
                      </td>
                      <td><a class="btn">
                      <?php switch($v["shop"]["shop_status"]): case "0": ?><font color="red">未营业</font><?php break;?>
                        <?php case "1": ?>营业中<?php break; endswitch;?>
                      </a>
                      </td>
                      <td><?php echo (date('Y-m-d H:i:s',$v["posttime"])); ?></td>
                      <td>
                        <a class="btn btn-success" href="<?php echo U('edit',array('id'=>$v['id']));?>"> 编辑</a>
						<a class="btn btn-danger" onclick="return confirm('确定删除？')"  href="<?php echo U('del',array('id'=>$v['id']));?>" uid="<?php echo ($v["shop"]["uid"]); ?>"> 删除</a>
                      </td>
