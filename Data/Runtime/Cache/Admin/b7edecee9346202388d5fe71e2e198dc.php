        ...
        <div class="content-box-content">
          ...
          <div class="tab-content default-tab" id="tab1">
            ...
            <form action="" method="post">
                搜索： <input value="<?php echo ($_POST['key']); ?>" name="key" type="text" class="text-input small-input" placeholder="关键字"/>
                &nbsp;&nbsp;
                ...
                &nbsp;&nbsp;&nbsp;店铺名称，微信昵称，姓名
                &nbsp;&nbsp;&nbsp;
                 <a href="<?php echo U('Resaler/top100');?>" target="_blank">查看top100</a>
                </form>
            </p>
            <table width='100%'>
              <thead>
              ...
              <tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                     ...
                     <!-- <td>
                      ...
                      <td>
                     <?php echo ((mb_substr($v["nickname"],0,8,'utf-8'))?(mb_substr($v["nickname"],0,8,'utf-8')):'暂无'); ?>
                      </td>
                      <td><?php echo ($v["invite_code"]); ?></td>
                      <td><a href="<?php echo U('store',array('id'=>$v['id']));?>" title="点击查看下级店铺"><?php echo ($v["invite_num"]); ?></a></td>
                      <td><a class="btn btn-danger confirm" href="<?php echo U('cancel_resaler',array('id'=>$v['id']));?>">取消</a></td>
                      <td>
                      <?php if(($v["posttime"]) == "0"): ?>暂无
                      <?php else: echo (date('Y-m-d H:i:s',$v["posttime"])); endif; ?>
                      </td>
                      <td>
                         <a title="查看/编辑" class='btn' href="<?php echo U('edit',array('id'=>$v['id']));?>">编辑</a>
                      	 <?php if(($v["username"]) != ""): ?><a class='btn' href="<?php echo U('Wxusers/pwd',array('id'=>$v['id']));?>">修改密码</a><?php endif; ?>
                      </td>
