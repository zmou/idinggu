                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                 ...
                 <!-- <a class="btn" title="修改订单支付状态" href="<?php echo U('update_pay_status',array('order_id'=>$v['id'],'p'=>I('get.p','1')));?>">
                  ...
                  <td>
                    ...
                    <a class="btn btn-success" href="<?php echo U('edit',array('id'=>$v['id']));?>">详情</a>
                    <a class="btn btn-danger" onclick="return confirm('确定删除？')" href="<?php echo U('del',array('id'=>$v['id']));?>">删除</a>
                  </td>
