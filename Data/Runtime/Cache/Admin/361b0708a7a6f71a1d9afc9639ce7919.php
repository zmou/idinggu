...
<div class="tab-content default-tab" id="tab1">
            <form method="post" action="<?php echo U('email');?>">
             	<p>
                   邮件服务器：<input type="text" name="host"  class="text-input small-input" value="<?php echo ($info["host"]); ?>" placeholder="邮件服务器地址" required> 
                </p>
                <p>
                   账户名　　：<input type="text" name="user"  class="text-input small-input" value="<?php echo ($info["user"]); ?>" placeholder="邮箱账户名" required> 
                </p>
                <p>
                   账户密码　：<input type="text" name="pwd"  class="text-input small-input" value="<?php echo ($info["pwd"]); ?>" placeholder="邮箱账户密码" required> 
                </p>
                <p>
                   发件人昵称：<input type="text" name="nickname"  class="text-input small-input" value="<?php echo ($info["nickname"]); ?>" placeholder="发件人昵称" required> 
                </p>                    
               <p>
