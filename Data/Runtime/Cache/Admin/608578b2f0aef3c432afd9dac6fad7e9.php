...
<h4>编辑角色</h4>  、
<a class="btn align-right" style="margin:5px 10px;" href="<?php echo U('role');?>">返回</a> 
...
<div class="tab-content default-tab" id="tab1">
            <form method="post" action="<?php echo U('RBAC/editRole',array('id'=>I('get.id')));?>">
              <fieldset>
                <p>
                    角色名称：<input required type="text" name="name"  class="text-input small-input" value="<?php echo ($info["name"]); ?>" /> 
                    
                    <!--<span class="input-notification success png_bg">Successful message</span>-->
                </p>
                <p>
                    角色描述：<input type="text" name="remark"  class="text-input small-input" value="<?php echo ($info["remark"]); ?>"> 
                    <!--<span class="input-notification error png_bg">Error message</span>-->
                </p>
                <p>
                    是否开启：<input type="radio" name="status" value="1" <?php if(($info["status"]) == "1"): ?>checked="checked"<?php endif; ?> />&nbsp;开启&nbsp;
