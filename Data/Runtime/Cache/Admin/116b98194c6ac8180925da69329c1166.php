...
<h4>CMS栏目管理</h4>  
<a href="<?php echo U('sortadd');?>" style="float: right;margin:5px 10px;" class="btn">新增</a>
        ...
        <div class="content-box-content">
          ...
          <div class="tab-content default-tab" id="tab1">
            ...
            <table>
              ...
              <tbody>
                <?php if(is_array($plist)): $i = 0; $__LIST__ = $plist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                      <td>【<?php echo ($v["id"]); ?>】</td>
                      <td><?php if($v['fup'] == 0): else: ?>┠<?php endif; ?>&nbsp;<a href="<?php echo U('CmsArt/artlist',array('fid'=>$v['id'],'mid'=>$v['class']));?>" title="title"><?php echo ($v["name"]); ?></a></td>
                      <td><?php echo (cmstype(1,$v["type"])); ?></td>
                      <td><?php echo (cmstype(2,$v["class"])); ?></td>
                      <td>[LIST:<?php echo ($v["list_html"]); ?>] &nbsp; [BENCANDY:<?php echo ($v["bencandy_html"]); ?>]</td>
                      <td>
<?php if($v['type'] == 1): ?><a class="btn btn-success" href="<?php echo U('CmsArt/artadd',array('fid'=>$v['id'],'mid'=>$v['class']));?>">发布</a>
                        <a class="btn btn-success" href="<?php echo U('CmsArt/artlist',array('fid'=>$v['id'],'mid'=>$v['class']));?>" >管理</a>
                         <a class="btn btn-success" href="<?php echo U('sortadd',array('id'=>$v['id']));?>" title="Edit">配置</a>

<?php elseif($v['type'] == 2): ?>
						<a class="btn btn-success" href="<?php echo U('sortaloneedit',array('id'=>$v['id']));?>" title="Edit">编辑</a>
<?php else: ?>
						<a class="btn btn-success" href="<?php echo U('sortadd',array('id'=>$v['id']));?>" title="Edit">配置</a><?php endif; ?>                      	
                         <a class="btn btn-danger" href="<?php echo U('sortdel',array('id'=>$v['id']));?>" onClick="return confirm('是否将此栏目删除?')" title="Delete">删除</a> 
                      </td>
