...
<div class="tab-content default-tab" id="tab1">
            <form method="post" action="<?php echo U('index');?>">
             	<p>
                   网站标题　　：<input type="text" name="web_name"  class="text-input small-input" value="<?php echo ($conf["web_name"]); ?>"> 
                </p>
                <p>
                   网站描述　　：<input type="text" name="web_descrip"  class="text-input medium-input" value="<?php echo ($conf["web_descrip"]); ?>"> 
                </p>
                <p>
                   网站关键字　：<input type="text" name="web_key"  class="text-input medium-input" value="<?php echo ($conf["web_key"]); ?>"> 
                </p>             
                <p>
                   网站备案号　：<input type="text" name="web_beian"  class="text-input small-input" value="<?php echo ($conf["web_beian"]); ?>"> 
                </p>      
                 <p>
                   联系电话　　：<input type="text" name="phone"  class="text-input small-input" value="<?php echo ($conf["phone"]); ?>"> 
                </p>        
                <p>
                   电子邮箱　　：<input type="text" name="email"  class="text-input small-input" value="<?php echo ($conf["email"]); ?>"> 
                </p>   
				<p>
                   版权信息　　：<input type="text" name="copyright"  class="text-input small-input" value="<?php echo ($conf["copyright"]); ?>"> 
                </p>
				<br>
				<br>   
				<p>
				微信分享说明　　：<textarea name="share_message"  class="text-input small-input"><?php echo ($conf["share_message"]); ?></textarea>
                </p>
				<p>
				商店公告　　：<textarea name="shop_notice"  class="text-input small-input"><?php echo ($conf["shop_notice"]); ?></textarea>
                </p>
				<p>
				暂停营业　　：<textarea name="close_desc"  class="text-input small-input"><?php echo ($conf["close_desc"]); ?></textarea>
                </p>
                <p>
                   营业时间　　：<input type="text" name="open_time"  class="text-input small-input" value="<?php echo ($conf["open_time"]); ?>"> 
                </p>   
                <p>
                   店长专线　　：<input type="text" name="shop_hot_line"  class="text-input small-input" value="<?php echo ($conf["shop_hot_line"]); ?>"> 
                </p>   
                <p>
                   申请店长成功　　：<input type="text" name="apply_success"  class="text-input small-input" value="<?php echo ($conf["apply_success"]); ?>"> 
                </p>   
                <p>
                   用户最小金额　　：<input type="text" name="user_min_amount"  class="text-input small-input" value="<?php echo ($conf["user_min_amount"]); ?>"> 
                </p>   
                <p>
                   店长最小金额　　：<input type="text" name="shop_min_amount"  class="text-input small-input" value="<?php echo ($conf["shop_min_amount"]); ?>"> 
                </p>   
            
				
                <p>
                   最低提现金额　　：<input type="text" name="min_withdraw_money"  class="text-input small-input" value="<?php echo ($conf["min_withdraw_money"]); ?>">
                </p>   
                <p>
				提现说明　　：<textarea name="withdraw_desc"  class="editor" style="height:200px;"><?php echo ($conf["withdraw_desc"]); ?></textarea>
                </p>   
               <p>
