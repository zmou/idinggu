...
<h4>公众号菜单设置</h4>  
        ...
        <div class="content-box-content">
          ...
          <div class="tab-content default-tab" id="tab1">
            <div class="notification success png_bg" id="dmsg" style="display:;">
            ...
            <table>
              ...
              <tbody>
                <?php if(is_array($plist)): $i = 0; $__LIST__ = $plist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                      <td>【<?php echo ($v["id"]); ?>】</td>
                      <td><?php if($v['fup'] == 0): ?>⊙<?php else: ?>┠<?php endif; ?>&nbsp;<a href="#" title="title"><?php echo ($v["name"]); ?></a></td>
                      <td><?php if($v['type'] == 0): ?>按钮(click)<?php else: ?>链接(view)<?php endif; ?></td>
                      <td><?php echo ($v["key"]); ?></td>
                      <td><?php echo ($v["list"]); ?></td>
                      <td>
						<a class="btn btn-success" href="<?php echo U('menuadd',array('id'=>$v['id']));?>" title="Edit">编辑</a>
                    	
                         <a class="btn btn-danger" href="<?php echo U('menudel',array('id'=>$v['id']));?>" onClick="return confirm('是否将此菜单删除?')" title="Delete">删除</a> 
                      </td>
              ...
              <tfoot>
                <tr>
                  <td colspan="6">
                    ...
                    <a class="button" href="<?php echo U('menuadd');?>">添加菜单</a>&nbsp;&nbsp;&nbsp;
                    <a class="button" href="<?php echo U('menusend');?>" rel="modal">生成菜单</a>&nbsp;&nbsp;&nbsp;
                    <a class="button" href="<?php echo U('menuget');?>" rel="modal">查看当前菜单</a>&nbsp;&nbsp;&nbsp;
                    <a class="button" href="https://mp.weixin.qq.com/debug" target="_blank">微信接口调试地址</a>&nbsp;&nbsp;&nbsp;
