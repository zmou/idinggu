...
<h3>开通账号</h3>  
<a href="<?php echo U('audit');?>" style="font-weight: 700;margin:5px 10px;" class="btn align-right">返回</a>
...
<form method="post" action="<?php echo U('set_account',array('id'=>I('get.id')));?>" enctype="multipart/form-data">
    <fieldset>
<!--    <p><a class='button'>店长信息</a></p>-->
	<div class="block">
    <p>
        登录账号：
        	<input type="text" name="username"  class="text-input small-input" value="<?php echo ($info["username"]); ?>" placeholder="登录账号"/> 
    </p>
     <p>
        登录密码：
