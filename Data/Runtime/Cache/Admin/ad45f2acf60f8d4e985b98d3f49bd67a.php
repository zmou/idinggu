...
<div class="tab-content default-tab" id="tab1">
    <form method="post" action="<?php echo U('edit',array('id'=>I('get.id')));?>">
      <fieldset>
        ...
        <p>
            商品简介：<input value="<?php echo ($info["descrip"]); ?>" placeholder="商品简介"  required type="text" name="descrip"  class="text-input small-input"> 
        </p>
         <p>
       ...
       <p>
            所属分类：<?php if(is_array($categorys)): $i = 0; $__LIST__ = $categorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><input name='cid[]' type='checkbox' value="<?php echo ($val["id"]); ?>" <?php if(in_array($val['id'],explode(',',$info['cid']))): ?>checked<?php endif; ?> ><?php echo ($val["name"]); endforeach; endif; else: echo "" ;endif; ?>
        </p>
        <p>
         ...
         <p>
            规　　格：<input  value="<?php echo ($info["standard"]); ?>"  required type="text" name="standard"  class="text-input small-input"> 
        </p>
        <p>
            保质期　：<input  value="<?php echo ($info["life_time"]); ?>"  required type="text" name="life_time"  class="text-input small-input"> 
        </p>
        <p>
             销　　量：<input value="<?php echo ($info["sale_num"]); ?>" placeholder="库存数量"  required type="text" name="sale_num"  class="text-input small-input num"> 
        </p>-->
        <p>
            库存数量：<input value="<?php echo ($info["store_num"]); ?>" placeholder="库存数量"  required type="text" name="store_num"  class="text-input small-input num"> 
        </p>
        <p>
            市场价格：<input value="<?php echo ($info["market_price"]); ?>" placeholder="市场价格"  required type="text" name="market_price"  class="text-input small-input num"> 元
        </p>
        <p>
            所需咕币：<input value="<?php echo ($info["price"]); ?>" placeholder="所需咕币"  required type="text" name="price"  class="text-input small-input num"> 咕币
        </p>
        <p>
            缩 略 图：
        ...
        <p>
            商品介绍：<textarea id="myEditor" name="content"  style="height:300px;"><?php echo (stripslashes(htmlspecialchars_decode($info["content"]))); ?></textarea>
