...
<div class="tab-content default-tab" id="tab1">
    <form method="post" action="<?php echo U('Database/back');?>">
        <p>
           备份类型：<select name="back_type">
                    <option value="1">完全备份</option>
                    </select>
                    <input type="submit" value="备份" class="button">
       </p>  			
      <div class="clear"></div>
    </form>
    <table>
      ...
      <tbody>
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td>
              <a href="<?php echo U('click',array('table'=>$item['Name'],'do'=>'optimize'));?>" title="优化表" class="btn btn-success">优化表</a>
              <a href="<?php echo U('click',array('table'=>$item['Name'],'do'=>'repair'));?>" title="优化表" class="btn btn-success">修复表</a>  
              </td>
