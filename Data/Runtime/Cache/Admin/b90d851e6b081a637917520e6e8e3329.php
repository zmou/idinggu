...
<h4>友情链接列表</h4> 
<a href="<?php echo U('add');?>" style="float: right;font-weight: 700;margin:5px 10px;" class="btn">新增</a>
            ...
            <table>
              ...
              <tbody>
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                      <td><?php echo ($v["id"]); ?></td>
                      <td><a href="<?php echo ($v["linkurl"]); ?>" target="_blank" title="<?php echo ($v["linkname"]); ?>"><?php echo ($v["linkname"]); ?></a></td>
                      <td><a href="<?php echo ($v["linkurl"]); ?>" target="_blank" title="<?php echo ($v["linkname"]); ?>"><?php echo ($v["linkurl"]); ?></a></td>
                      <td><a href="<?php echo ($v["linkurl"]); ?>" target="_blank" title="<?php echo ($v["linkname"]); ?>">
                      <img src="<?php echo ($v["linklogo"]); ?>" class="thumb"></a></td>
                      <td><?php echo ($v["linklist"]); ?></td>
                      <td>
                        <?php if(($v["linktype"]) == "0"): ?><a class="btn" title="隐藏">隐藏</a><?php endif; ?>
                      	<?php if(($v["linktype"]) == "1"): ?><a class="btn"  title="显示">显示</a><?php endif; ?>
                      </td>  
                      <td>
                        <a class="btn btn-success" href="<?php echo U('edit',array('id'=>$v['id']));?>">修改</a>                  	
                        <a class="btn btn-danger" href="<?php echo U('del',array('id'=>$v['id']));?>" onClick="return confirm('确定要删除此链接?')">删除</a> 
                      </td>
