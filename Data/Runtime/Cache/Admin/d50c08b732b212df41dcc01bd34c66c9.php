...
<form method="post" action="<?php echo U('edit',array('id'=>I('get.id')));?>" enctype="multipart/form-data">
    ...
    <p>
        标　　题：
        	<input required="required" type="text" name="title"  class="text-input small-input"  value="<?php echo ($info["title"]); ?>"/> 
    </p>
    <p>
        链接地址：
        	<input type="text" name="url"  class="text-input small-input" value="<?php echo ($info["url"]); ?>"/> 
    </p>
    <p>
    图　　片：
    <input readonly name="spic" type="text" id="url1" class="text-input small-input" value="<?php echo ($info["spic"]); ?>"/> 
