...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="friend_order_list" id="order_<?php echo ($v["id"]); ?>">
	...
	<dl>
		...
		<dd>
			...
			<p align="right"><span style="float:left;">￥<?php echo ($g["trade_price"]); ?></span>数量：<?php echo ($g["goods_nums"]); ?>x<?php echo ($g["package_num"]); ?></p>
			<p align="right">实付款：￥<?php echo $g['trade_price']*$g['goods_nums']*$g['package_num'];?></p>  
		</dd>
