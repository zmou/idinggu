    ...
    <!--<div class="notification <?php if(($shop["shop_status"]) == "1"): ?>success<?php else: ?>error<?php endif; ?> png_bg" id="dmsg">
        ...
        <div>
            ...
            <form method="post" action="<?php echo U('edit');?>">
              <fieldset>
                <p>
                    店长姓名：<input type="text" name="name"  class="text-input small-input" value="<?php echo ($info["name"]); ?>" placeholder="姓名"/>
                </p>
                <p>
                    联系电话：<input type="text" name="mobile"  class="text-input small-input number" value="<?php echo ($info["mobile"]); ?>" placeholder="联系电话"/>
                </p>
                <p>
                ...
                <p>
                    电子邮件：<input type="text" name="email"  class="text-input small-input" value="<?php echo ($info["email"]); ?>" placeholder='电子邮件'/>
                </p>
                <p>
                    银行卡号：<input type="text" name="bank_card"  class="text-input small-input number" value="<?php echo ($info["bank_card"]); ?>" placeholder='银行卡号'/>
                </p>
                <p>
                资金账户：【<b>&yen;</b> <?php echo ($info["money_account"]); ?>】	
